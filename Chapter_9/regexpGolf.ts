...
const string3 =
  "The ferrari regularly transported a ferret across the feral ferrule of a ferry";
...
const quote = /([^\w])'|'([^\w])/g;
const string8 =
  "The woman said 'this is too good to pass up, ain't it', and I said 'I'm against it all'";
